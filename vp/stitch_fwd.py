...
# below is a forward stitching method that concatenates multiple bevs.
# it is straight-forward but not in an optimized way, since it will consume
...
def stitch(
    ...
    print(f"bev[0] shape is : {bevs[0].shape}")
    for bev in bevs:
